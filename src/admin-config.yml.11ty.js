...
function itemFields(entry) {
  const fields = [
    ...
    {
      label:
        '📍 الإحداثيات (اختياري — لميزة "قريب مني"). الصقها كما هي بأي صيغة:\n' +
        '• الإحداثيات مباشرة: 26.2334276, 50.5192457\n' +
        '• أو رابط خرائط قوقل كامل من شريط العنوان بالكمبيوتر\n' +
        'الموقع يفصلها تلقائياً — ما تحتاج تقسّمها بيدك',
      name: "coords",
      widget: "string",
      required: false,
      hint: "افتح المكان بخرائط قوقل على الكمبيوتر، وانسخ الرابط من شريط العنوان والصقه هنا.",
    },
