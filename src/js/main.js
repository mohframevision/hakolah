...
function initTypingTest() {
  ...
  const LEVELS = {
    ...
    easy: [
      ...
      "الطريق إلى إتقان أي مهارة يبدأ بخطوة صغيرة تتكرر كل يوم.",
      "من زرع شجرة اليوم جلس في ظلها بعد سنوات.",
    ...
    medium: [
      ...
      "لا تؤجل عمل اليوم إلى الغد، فالوقت أثمن ما تملك ولا يشترى بمال.",
