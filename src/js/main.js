...
function initTypingTest() {
  ...
  /* فصحى أدبية لا لغة مدرسية مبسّطة: الاختبار تحدٍّ لا تمرين ابتدائي، والجمل
     الراقية تكثر فيها الهمزات (أ إ ؤ ئ ء) والتاء المربوطة والألف المقصورة —
     وهي بالضبط ما يفرّق الكاتب المتقن عن غيره على لوحة المفاتيح.
     بلا أي حركة (شدّة/ضمّة/تنوين): يجب أن يطابق المستخدم النص حرفاً حرفاً،
