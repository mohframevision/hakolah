...
/* تكبير الصفحة كلها بنسبة عرض الشاشة فوق 1440px — نفس تصميم لابتوب 1440
   بالضبط بس أكبر بالتناسب على الشاشات العريضة (2K/4K)، بدل محتوى صغير بنص
   فراغ. أغلب مقاسات style.css بكسل ثابت (642 مقاس)، فتكبير خط الجذر وحده ما
   يكفي. تحت 1440 (لابتوب/جوال) صفر تغيير — التصميم المتجاوب الحالي يغطيها.
   عرض التخطيط الفعلي يبقى 1440 (فوق أكبر نقطة كسر 1300px)، فاستعلامات
   media ما تتعارض. ملف بالـhead عشان يطبَّق قبل أول رسم بلا قفزة. */
(function () {
  var root = document.documentElement;
  function fit() {
    root.style.zoom = Math.min(1.8, Math.max(1, window.innerWidth / 1440));
  }
  fit();
